...
namespace DTerrain {
    ...
    public class PaintableChunk : MonoBehaviour, ITexturedChunk {
        ...
        public virtual void Init() {
            ...
            SpriteRenderer.sprite = Sprite.Create(TextureSource.Texture,
                new(0, 0, TextureSource.Texture.width, TextureSource.Texture.height), new(0.0f, 0.0f),
                TextureSource.PPU, 0, SpriteMeshType.FullRect);
        ...
        public virtual bool Paint(RectInt r, PaintingParameters pp) {
            ...
            RectInt common;
            r.Intersects(new(0, 0, TextureSource.Texture.width, TextureSource.Texture.height), out common);
            ...
            if (pp.PaintingMode == PaintingMode.REPLACE_COLOR) {
                ...
                for (int i = 0; i < common.width; i++) {
                    for (int j = 0; j < common.height; j++) {
                        cs[i * common.height + j] =
                            TextureSource.Texture.GetPixel(common.x + i, common.y + j) + pp.Color;
                    }
                }
            }
