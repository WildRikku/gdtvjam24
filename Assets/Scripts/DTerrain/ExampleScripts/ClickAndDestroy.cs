...
namespace DTerrain {
    ...
    public class ClickAndDestroy : MonoBehaviour {
        ...
        protected virtual void OnLeftMouseButtonClick() {
            ...
            primaryLayer?.Paint(new() {
                Color = Color.clear,
                Position = new((int)(p.x * primaryLayer.PPU) - circleSize, (int)(p.y * primaryLayer.PPU) - circleSize),
                Shape = destroyCircle,
                PaintingMode = PaintingMode.REPLACE_COLOR,
                DestructionMode = DestructionMode.DESTROY
            });

            secondaryLayer?.Paint(new() {
                Color = new(0.0f, 0.0f, 0.0f, 0.75f),
                Position = new((int)(p.x * secondaryLayer.PPU) - circleSize - outlineSize,
